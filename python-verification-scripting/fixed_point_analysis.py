...
#print("-0.225 mV can be represented as: ", float_to_fp(-0.225,16,47))
print("-60.0 mV can be represented as: ", float_to_fp(-60.0,16,47))
print("-52.0 mV can be represented as: ", float_to_fp(-52.0,16,47))

# 32 = 1 11 20 - can later be changed to another representation with less bits or more.

# Now some weights for reference:
